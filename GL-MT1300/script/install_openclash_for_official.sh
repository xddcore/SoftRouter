...
cd /tmp
wget --no-check-certificate https://downloads.openwrt.org/snapshots/packages/mipsel_24kc/base/libcap_2.51-1_mipsel_24kc.ipk
opkg install /tmp/libcap_*.ipk
wget --no-check-certificate https://downloads.openwrt.org/snapshots/packages/mipsel_24kc/base/libcap-bin_2.51-1_mipsel_24kc.ipk
